...
def randomize_config(file_path):
    ...
    ##small range
    config['rowNum'] = 10 # Choose a suitable range
    config['colNum'] = 10 # Choose a suitable range

	# #medium range
 	# config['rowNum'] = 50 # Choose a suitable range
    # config['colNum'] = 50 # Choose a suitable range

	# #large range
	# config['rowNum'] = 100 # Choose a suitable range
	# config['colNum'] = 100  # Choose a suitable range
